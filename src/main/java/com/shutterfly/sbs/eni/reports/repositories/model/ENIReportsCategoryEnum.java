...
public enum ENIReportsCategoryEnum {
  ...
  INVOICING_SHIPPED_REPORT("INVOICING REPORT BY SHIPPED","invoicingRepo"),
  ...
  MPT__REPORT_ORDER_COUNTS_BY_BUSINESS_SEGMENT("MPT__REPORT_ORDER_COUNTS_BY_BUSINESS_SEGMENT","mptRepoByBusinessSegment"),
  ...
  MPT__REPORT_ORDER_COUNTS_TOTALS("MPT__REPORT_ORDER_COUNTS_TOTALS","mptRepoOrderCountTotal");
