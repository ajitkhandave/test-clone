...
export class OrderDetailsLineItemLevelComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.columns = [
      ...
      { prop: 'quantityOrdered', name: 'Qty Ordered', sortable: true, draggable: false, resizeable: false },
      ...
      { prop: 'quantityShipped', name: 'Qty Shipped', sortable: true, draggable: false, resizeable: false },
